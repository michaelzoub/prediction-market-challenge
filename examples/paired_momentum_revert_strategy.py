...
class Strategy(BaseStrategy):
    """Blend momentum and mean-reversion with inventory-aware pairing."""
    ...
    def on_step(self, state: StepState) -> Sequence[Action]:
        ...
        # When trend is strong, lean with trend but keep opposite quote alive for paired fills.
        trend_skew = 0
        if trend > 0.22:
            trend_skew = 1
        elif trend < -0.22:
        ...
        # Pairing heuristic: if one side recently filled more, increase opposite side size.
        buy_size = base_size
        sell_size = base_size
